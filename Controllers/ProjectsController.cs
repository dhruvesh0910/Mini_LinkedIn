...
namespace mini_linkedIn.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ProjectsController(LinkedInContext context)
        {
            _context = context;
        }
        ...
        {
            var linkedInContext = _context.Projects.Include(p => p.user);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProjectID,Title,TechnologyUsed,LanguageUsed,StartYear,EndYear,Description,UserID")] Project project)
        {
