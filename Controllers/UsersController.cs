...
namespace mini_linkedIn.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(LinkedInContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,FirstName,LastName,UserName,PassWord,MobileNo,EmailID")] User user)
        {
            if (id != user.UserID)
            {
                return NotFound();
